...
class ClusterSpec extends TestBase with EmbeddedCassandra {
  ...
  override protected def beforeAll(): Unit = {
    ...
    (EmbeddedCassandra.creationScripts ++ List(
      CqlScript.ofString(
        "INSERT INTO acct_system.acct_events (owner_id, identity_id, day, id, category, created_at, description, occurred_at, token_value) VALUES (963995ed-ce12-4ea5-89dc-b181701d1d7b, 7549acd8-91e1-4230-833a-2f386e09b96f, '2020-12-03', 15f0c427-5dfb-4e15-853c-0770dd400763, 'verification', '2020-12-03 19:44:44.261', 'Lana Del Rey - Bogota Concert', '2020-12-03 19:44:43.243', 'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiJ9..asqbiVNGesd6-S-tE0M7uJs6Kw2xEVMASo9M6XpSrJhXdj4qrnW-9EcgdvV2FGowrTeEFqS0zrt7LxphkQh-Wg');".stripMargin
      )
